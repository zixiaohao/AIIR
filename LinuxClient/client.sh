...
# ================= 使用说明 =================
# 使用方法:
#   ./client.sh -s http://SERVER_IP:8000
#   ./client.sh --server http://SERVER_IP:8000
#   ./client.sh -h  # 查看帮助
#   ./client.sh     # 交互式输入服务器地址
# ===========================================

# 显示帮助信息
show_help() {
    echo "Linux 安全应急响应检测工具 v3.1"
    echo ""
    echo "用法:"
    echo "  ./client.sh -s <Server地址>"
    echo "  ./client.sh --server <Server地址>"
    echo "  ./client.sh -h  # 显示此帮助信息"
    echo ""
    echo "参数:"
    ...
    echo ""
    echo "示例:"
    echo "  ./client.sh -s http://192.168.1.100:8000"
    echo "  ./client.sh --server http://10.0.0.50:8000"
    echo ""
    echo "注意:"
    echo "  - 脚本需要root权限运行"
